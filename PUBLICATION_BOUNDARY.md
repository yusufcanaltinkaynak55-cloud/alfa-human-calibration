# Public release boundary / Kamusal yayın sınırı
...
publishing or rewriting the private project's Git history.

Bu depo bağımsız oluşturulmalıdır. Özel projenin Git geçmişi yayımlanarak veya
yeniden yazılarak üretilmemelidir.
